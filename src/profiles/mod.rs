...
trait Profile {
    ...
    fn send(&mut self, _: &str) -> Result<String, Box<dyn Error>>;
}
...
impl Profile {
    ...
    pub fn new(uuid: String) -> Self {
        ...
        let mut profiles: Vec<Box<dyn Profile>> = Vec::new();
    ...
    pub fn send_data(&mut self, data: &str) -> Result<String, Box<dyn Error>> {
        // Debug Print
        println!("[*] I'm just in send_data.");

        // No profiles are available
        if self.profiles.is_empty() {
            println!("[*] No Profile is set.");
        ...
        // Debug Print
        println!("[*] I'm just in send_data after set profiles.");
        ...
        let body = profile.send(&req_payload).unwrap();
